...
class AppStrings {
  ...
  String get checkingForUpdates => _localizedValues['checkingForUpdates']!;
  String get alreadyLatestVersion => _localizedValues['alreadyLatestVersion']!;
  String get updateCheckFailed => _localizedValues['updateCheckFailed']!;
  String get updateFailed => _localizedValues['updateFailed']!;
  String get downloadingUpdate => _localizedValues['downloadingUpdate']!;
  String get downloadFailed => _localizedValues['downloadFailed']!;
  String get downloadComplete => _localizedValues['downloadComplete']!;
  String get runInstallerNowQuestion => _localizedValues['runInstallerNowQuestion']!;
...
class _AppStringsDelegate extends LocalizationsDelegate<AppStrings> {
  ...
  Future<AppStrings> load(Locale locale) {
    return SynchronousFuture<AppStrings>(
        AppStrings(locale, locale.languageCode == 'zh' ? _zhValues : _enValues));
  }
  ...
  static const Map<String, String> _zhValues = {
    ...
    'importing': '正在导入...',
    'noPlaylists': '暂无播放列表',
    'addFirstPlaylist': '添加您的第一个播放列表',
    'deletePlaylist': '删除播放列表',
    'deleteConfirmation': '确定要删除 "{name}" 吗？这将同时删除此列表中的所有频道。',
    'cancel': '取消',
    'delete': '删除',
    'settings': '设置',
    'language': '语言',
    'general': '通用',
    'followSystem': '跟随系统',
    'languageFollowSystem': '设置为跟随系统语言',
    'theme': '主题',
    'themeDark': '深色',
    'themeLight': '浅色',
    'themeSystem': '跟随系统',
    ...
    'playback': '播放',
    'autoPlay': '启动时自动播放',
    'autoPlaySubtitle': '应用启动时自动继续播放上次观看的内容',
    ...
    'playlists': '播放列表',
    'autoRefresh': '自动刷新',
    'autoRefreshSubtitle': '自动定期更新播放列表',
    'refreshInterval': '刷新间隔',
    'hours': '小时',
    'days': '天',
    'day': '天',
    'rememberLastChannel': '记住上一个频道',
    'rememberLastChannelSubtitle': '从上次观看的频道继续播放',
    'epg': 'EPG (电子节目指南)',
    'enableEpg': '启用 EPG',
    'enableEpgSubtitle': '显示频道的节目信息',
    'epgUrl': 'EPG 链接',
    'notConfigured': '未配置',
    'parentalControl': '家长控制',
    'enableParentalControl': '启用家长控制',
    'enableParentalControlSubtitle': '访问受限内容需输入 PIN 码',
    'changePin': '修改 PIN 码',
    'changePinSubtitle': '更新您的家长控制 PIN 码',
    'about': '关于',
    'platform': '平台',
    'resetAllSettings': '重置所有设置',
    'resetSettingsSubtitle': '将所有设置恢复为默认值',
    ...
    'playbackSpeed': '播放速度',
    'shortcutsHint': '左右键: 快进/快退 • 上下键: 切换频道 • 回车: 播放/暂停 • M: 静音',
    ...
    'noChannelsMatch': '没有频道匹配 "{query}"',
    'resultsFor': '关于 "{query}" 的 {count} 个结果',
    'favorites': '收藏',
    'clearAll': '清除全部',
    'noFavoritesYet': '暂无收藏',
    'favoritesHint': '长按频道添加至收藏',
    'noProgramInfo': '暂无节目信息',
    'browseChannels': '浏览频道',
    'removedFromFavorites': '已从收藏中移除 "{name}"',
    'undo': '撤销',
    'clearAllFavorites': '清除所有收藏',
    'clearFavoritesConfirm': '确定要移除所有已收藏的频道吗？',
    'allFavoritesCleared': '所有收藏已清除',
    'home': '首页',
    'managePlaylists': '管理播放列表',
    'noPlaylistsYet': '暂无播放列表',
    'addFirstPlaylistHint': '添加您的第一个 M3U 播放列表开始观看',
    'addPlaylist': '添加播放列表',
    'totalChannels': '频道总数',
    'volumeNormalization': '音量标准化',
    'volumeNormalizationSubtitle': '自动调整不同频道间的音量差异',
    'volumeBoost': '音量增强',
    'noBoost': '无增强',
    'checkUpdate': '检查更新',
    ...
    'decodingMode': '解码模式',
    'decodingModeAuto': '自动',
    'decodingModeHardware': '硬件解码',
    'decodingModeSoftware': '软件解码',
    'decodingModeAutoDesc': '自动选择最佳选项。推荐。',
    'decodingModeHardwareDesc': '强制使用硬件解码。部分设备可能导致错误。',
    'decodingModeSoftwareDesc': '使用 CPU 软解码。兼容性更好但更耗电。',
    'volumeBoostLow': '显著降低音量',
    'volumeBoostSlightLow': '轻微降低音量',
    'volumeBoostNormal': '保持原始音量',
    'volumeBoostSlightHigh': '轻微增强音量',
    'volumeBoostHigh': '显著增强音量',
    'chinese': '中文',
    'english': 'English',
    ...
    'importSuccess': '导入成功',
    'importFailed': '导入失败',
    'serverStartFailed': '本地服务器启动失败。请检查网络连接。',
    'processing': '处理中，请稍候...',
    'testChannel': '测试频道',
    'unavailable': '不可用',
    'localFile': '本地文件',
    ...
    'channelStats': '{channels} 个频道 · {categories} 个分类 · {favorites} 个收藏',
    'noPlaylistYet': '暂无播放列表',
    'addM3uToStart': '添加 M3U 播放列表开始观看',
    'search': '搜索',
    'playerHintTV': '↑↓ 切换频道 · ←→ 切换源 · 长按← 分类 · 确定 播放/暂停 · 长按确定 收藏',
    'playerHintDesktop': '左右键: 快进/快退 · 上下键: 切换 · 回车: 播放/暂停 · M: 静音',
    'more': '更多',
    'close': '关闭',
    'startingServer': '服务器启动中...',
    'selectM3uFile': '请选择播放列表文件 (M3U/M3U8/TXT)',
    'noFileSelected': '未选择文件。请确保您的设备已配置 USB 存储或网络存储。',
    'epgAutoApplied': 'EPG 源已自动应用',
    'addFirstPlaylistTV': '通过 USB 或扫码导入',
    'addPlaylistSubtitle': '从链接或文件导入 M3U/M3U8 播放列表',
    'importFromUsb': '从 USB 或本地存储导入',
    'scanQrToImport': '使用手机扫描二维码',
    'playlistUrlHint': 'M3U/M3U8/TXT 链接',
    'qrStep1': '使用手机扫描二维码',
    'qrStep2': '在网页上输入链接或上传文件',
    'qrStep3': '点击导入，电视将自动接收',
    'qrSearchStep1': '使用手机扫描二维码',
    'qrSearchStep2': '在网页上输入搜索内容',
    ...
    'autoPlayEnabled': '启动时自动播放已启用',
    'autoPlayDisabled': '启动时自动播放已禁用',
    'bufferStrength': '缓冲强度',
    'showFps': '显示帧率',
    ...
    'clockEnabled': '时钟显示已启用',
    'clockDisabled': '时钟显示已禁用',
    'showNetworkSpeed': '显示网络速度',
    'showNetworkSpeedSubtitle': '在播放器右上角显示下载速度',
    'networkSpeedEnabled': '网络速度显示已启用',
    'networkSpeedDisabled': '网络速度显示已禁用',
    'showVideoInfo': '显示分辨率',
    'showVideoInfoSubtitle': '在右上角显示视频分辨率和码率',
    'videoInfoEnabled': '分辨率显示已启用',
    'videoInfoDisabled': '分辨率显示已禁用',
    'enableMultiScreen': '多屏模式',
    'enableMultiScreenSubtitle': '启用 2x2 分屏模式同时观看',
    'multiScreenEnabled': '多屏模式已启用',
    'multiScreenDisabled': '多屏模式已禁用',
    'showMultiScreenChannelName': '显示频道名称',
    'showMultiScreenChannelNameSubtitle': '在多屏播放中显示频道名称',
    'multiScreenChannelNameEnabled': '多屏频道名称显示已启用',
    'multiScreenChannelNameDisabled': '多屏频道名称显示已禁用',
    'defaultScreenPosition': '默认屏幕位置',
    'screenPosition1': '左上 (1)',
    'screenPosition2': '右上 (2)',
    'screenPosition3': '左下 (3)',
    'screenPosition4': '右下 (4)',
    'screenPositionDesc': '选择点击频道时默认使用的屏幕位置：',
    'screenPositionSet': '默认屏幕位置已设置为：{position}',
    'multiScreenMode': '多屏模式',
    'backToPlayer': '返回',
    'miniMode': '迷你模式',
    'exitMultiScreen': '退出多屏',
    'screenNumber': '屏幕 {number}',
    'clickToAddChannel': '点击添加频道',
    'selectChannel': '选择频道',
    'collapse': '折叠',
    'channelCountLabel': '{count} 个频道',
    'showOnlyFailed': '只显示失败频道 ({count})',
    'moveToUnavailable': '移至不可用',
    'stopTest': '停止测试',
    'startTest': '开始测试',
    'complete': '完成',
    'runInBackground': '后台运行',
    'movedToUnavailable': '已将 {count} 个不可用频道移至不可用分类',
    ...
    'runInstallerNow': '现在运行安装程序吗？',
    'later': '稍后',
    'installNow': '立即安装',
    'deletedChannels': '已删除 {count} 个不可用频道',
    'testing': '测试中: {name}',
    'channelAvailableRestored': '{name} 可用，已恢复至 "{group}" 分类',
    'testingInBackground': '后台测试中，剩余 {count} 个频道',
    'restoredToCategory': '已恢复 {name} 至原分类',
    'dlnaCast': 'DLNA 投屏',
    'notImplemented': '(暂未实现)',
    'volumeNormalizationNotImplemented': '音量标准化暂未实现，设置不会生效',
    'autoRefreshNotImplemented': '自动刷新暂未实现，设置不会生效',
    'rememberLastChannelEnabled': '记住上一个频道已启用',
    'rememberLastChannelDisabled': '记住上一个频道已禁用',
    'epgEnabledAndLoaded': 'EPG 已启用并加载成功',
    'epgEnabledButFailed': 'EPG 已启用但加载失败',
    ...
    'allowOtherDevicesToCast': '允许其他设备投屏到此设备',
    'dlnaServiceStartedMsg': 'DLNA 服务已启动',
    'dlnaServiceStoppedMsg': 'DLNA 服务已停止',
    'dlnaServiceStartFailed': 'DLNA 服务启动失败，请检查网络连接',
    'parentalControlNotImplemented': '家长控制暂未实现，设置不会生效',
    'changePinNotImplemented': '(暂未实现)',
    'decodingModeSet': '解码模式已设置为：{mode}',
    'fastBuffer': '快速 (切换快，可能卡顿)',
    'balancedBuffer': '平衡',
    'stableBuffer': '稳定 (切换慢，减少卡顿)',
    'bufferSizeNotImplemented': '缓冲大小设置暂未实现，设置不会生效',
    'volumeBoostSet': '音量增强已设置为 {value}',
    'noBoostValue': '无增强',
    'epgUrlSavedAndLoaded': 'EPG 链接已保存并加载成功',
    'epgUrlSavedButFailed': 'EPG 链接已保存但加载失败',
    'epgUrlCleared': 'EPG 链接已清除',
    'epgUrlSaved': 'EPG 链接已保存',
    'pinNotImplemented': '家长控制暂未实现，PIN 设置不会生效',
    'enter4DigitPin': '请输入 4 位 PIN 码',
    'allSettingsReset': '所有设置已重置为默认值',
    'languageSwitchedToChinese': '语言已切换为中文',
    'languageSwitchedToEnglish': '语言已切换为英文',
    'themeChangedMessage': '主题已切换为：{theme}',
    'defaultVersion': '默认版本',
    'colorScheme': '配色方案',
    ...
    'sentToTV': '已发送至电视，请在电视上查看',
    'sendFailed': '发送失败',
    'networkError': '网络错误，请确保设备在同一网络下',
    'uploading': '上传中...',
    'simpleMenu': '简单菜单',
    'simpleMenuSubtitle': '保持菜单折叠（不自动展开）',
    'simpleMenuEnabled': '简单菜单已启用',
    'simpleMenuDisabled': '简单菜单已禁用',
    'progressBarMode': '进度条显示',
    'progressBarModeSubtitle': '控制播放进度条的显示方式',
    'progressBarModeAuto': '自动检测',
    'progressBarModeAlways': '始终显示',
    'progressBarModeNever': '从不显示',
    'progressBarModeAutoDesc': '根据内容类型自动显示（点播/回看显示，直播隐藏）',
    'progressBarModeAlwaysDesc': '始终显示进度条',
    'progressBarModeNeverDesc': '从不显示进度条',
    ...
    'logLevelRelease': '发布',
    'logLevelOff': '关闭',
    'logLevelDebugDesc': '记录所有内容，用于开发和调试',
    'logLevelReleaseDesc': '仅记录警告和错误（推荐）',
    'logLevelOffDesc': '不记录任何内容',
    'exportLogs': '导出日志',
    'exportLogsSubtitle': '扫描二维码查看或导出日志文件',
    'clearLogs': '清除日志',
    'clearLogsSubtitle': '删除所有日志文件',
    'logFileLocation': '日志文件位置',
    'logsCleared': '日志已清除',
    'clearLogsConfirm': '清除日志',
    'clearLogsConfirmMessage': '确定要删除所有日志文件吗？',
    'errorTimeout': '连接超时，请检查网络或链接',
    'errorNetwork': '网络连接失败，请检查网络',
    'usingCachedSource': '远程源不可用，正在使用缓存源',
  };
  ...
  static const Map<String, String> _enValues = {
    ...
    'fontFamilyDesc': 'Select application font',
    ...
    'autoRefreshSubtitle': 'Automatically refresh playlists periodically',
    'refreshInterval': 'Refresh Interval',
    'hours': 'hours',
    'days': 'days',
    'day': 'day',
    'rememberLastChannel': 'Remember Last Channel',
    'rememberLastChannelSubtitle': 'Continue playback from the last watched channel',
    'epg': 'EPG',
    'enableEpg': 'Enable EPG',
    'enableEpgSubtitle': 'Show EPG info for channels',
    'epgUrl': 'EPG URL',
    'notConfigured': 'Not Configured',
    'parentalControl': 'Parental Control',
    'enableParentalControl': 'Enable Parental Control',
    'enableParentalControlSubtitle': 'PIN required to access restricted content',
    'changePin': 'Change PIN',
    'changePinSubtitle': 'Update your parental control PIN',
    'about': 'About',
    'platform': 'Platform',
    'resetAllSettings': 'Reset All Settings',
    'resetSettingsSubtitle': 'Reset all settings to default values',
    ...
    'reset': 'Reset',
    'pleaseEnterPlaylistName': 'Please enter playlist name',
    'pleaseEnterPlaylistUrl': 'Please enter playlist URL',
    'playlistAdded': 'Added "{name}"',
    'playlistRefreshed': 'Playlist refreshed',
    'playlistRefreshFailed': 'Playlist refresh failed',
    ...
    'typeToSearch': 'Type to search channels or categories',
    ...
    'favoritesHint': 'Hold channel to add to favorites',
    ...
    'decodingModeAutoDesc': 'Auto select best option. Recommended.',
    ...
    'volumeBoostLow': 'Significantly Lower',
    'volumeBoostSlightLow': 'Slightly Lower',
    'volumeBoostNormal': 'Normal',
    'volumeBoostSlightHigh': 'Slightly Higher',
    'volumeBoostHigh': 'Significantly Higher',
    'chinese': 'Chinese',
    'english': 'English',
    ...
    'selectM3uFile': 'Please select playlist file (M3U/M3U8/TXT)',
    ...
    'addFirstPlaylistTV': 'Import via USB or Scan',
    'addPlaylistSubtitle': 'Import M3U/M3U8 playlist from URL or file',
    'importFromUsb': 'Import from USB/Local',
    'scanQrToImport': 'Scan QR to Import',
    'playlistUrlHint': 'M3U/M3U8/TXT URL',
    'qrStep1': 'Scan QR with phone',
    'qrStep2': 'Enter URL or upload file on web',
    'qrStep3': 'Click import, TV will auto-receive',
    'qrSearchStep1': 'Scan QR with phone',
    'qrSearchStep2': 'Enter search on web',
    'qrSearchStep3': 'Results auto-show on TV',
    ...
    'showFps': 'Show FPS',
    'showFpsSubtitle': 'Show FPS in top-right corner of player',
    ...
    'networkSpeedEnabled': 'Network speed enabled',
    'networkSpeedDisabled': 'Network speed disabled',
    'showVideoInfo': 'Show Video Info',
    'showVideoInfoSubtitle': 'Show video resolution and bitrate in top-right',
    'videoInfoEnabled': 'Video info enabled',
    'videoInfoDisabled': 'Video info disabled',
    ...
    'showMultiScreenChannelName': 'Show Channel Name',
    'showMultiScreenChannelNameSubtitle': 'Display channel names in multi-screen playback',
    'multiScreenChannelNameEnabled': 'Multi-screen channel name enabled',
    'multiScreenChannelNameDisabled': 'Multi-screen channel name disabled',
    ...
    'epgEnabledAndLoaded': 'EPG enabled and loaded',
    'epgEnabledButFailed': 'EPG enabled but failed',
    ...
    'fastBuffer': 'Fast (Fast switch, may stutter)',
    'balancedBuffer': 'Balanced',
    'stableBuffer': 'Stable (Slow switch, fewer stutters)',
    ...
    'epgUrlSavedAndLoaded': 'EPG URL saved and loaded',
    'epgUrlSavedButFailed': 'EPG URL saved but failed',
    ...
    'colorSchemeDescSpring': 'Energetic, eye-friendly',
    ...
    'enterPlaylistUrl': 'Enter M3U/M3U8/TXT URL',
    ...
    'progressBarModeAlwaysDesc': 'Always show progress bar',
    ...
    'logLevel': 'Log Level',
    'logLevelSubtitle': 'Select log recording level',
    'logLevelDebug': 'Debug',
    'logLevelRelease': 'Release',
    'logLevelOff': 'Off',
    'logLevelDebugDesc': 'Record everything, for dev and debug',
    'logLevelReleaseDesc': 'Record only warnings and errors (recommended)',
    'logLevelOffDesc': 'Do not record anything',
    'exportLogs': 'Export Logs',
    'exportLogsSubtitle': 'Scan QR to view or export log file',
